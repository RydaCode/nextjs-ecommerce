...
const SingleItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative border border-[#afb3c6e1] overflow-hidden rounded-lg bg-[#F6F7FB] min-h-[403px]">
        ...
        <div className="text-center px-4 py-7.5">
          <div className="flex items-center justify-center gap-2.5 mb-2">
            ...
            <p className="text-custom-sm">({item.average_rating})</p>
          </div>
          ...
          <span className="flex items-center justify-center gap-2 font-medium text-lg">
            <span className="text-dark">K{item.final_price}</span>
            {/* <span className="text-dark-4 line-through">K{item.final_price}</span> */}
          </span>
        </div>

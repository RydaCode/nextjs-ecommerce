          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <div>
              <form  onSubmit={handleLogin}>
                ...
                {success ? (
                    <div className="flex justify-center text-green text-sm mb-3">
                      {success}
                    </div>
                  ) : error ? (
                    <div className="flex items-center justify-center text-red text-sm border border-red-300 bg-red-500 rounded-md p-2">
                      <span>{error}</span>
                    </div>
                  ) : null}
                <button

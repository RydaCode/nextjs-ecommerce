...
const ProductItem = ({ item }: { item: Stores }) => {
  ...
  return (
    <div className="group border rounded-lg border-[#afb3c6e1]">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 w-full flex items-center justify-center gap-2.5 pb-5">
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 ease-out duration-200 text-red bg-white hover:text-blue"
          >
            <svg
          ...
          <button
            ...
            className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-red text-white ease-out duration-200 hover:bg-blue-dark"
          >
            {item.store_category}
          </button>
      ...
      <div className="flex items-center gap-2.5 mb-2">
        ...
        <p className="text-custom-sm">{item.average_rating} ({item.total_ratings})</p>
      </div>

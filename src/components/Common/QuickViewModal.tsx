                ...
                <div className="relative z-1 overflow-hidden flex items-center justify-center w-full sm:min-h-[508px] bg-gray-1 rounded-lg border border-gray-3">
                  <div>
                    ...
                    {product?.product_images?.[0] && (
                      <Image
                        src={`${process.env.NEXT_PUBLIC_IMAGE_URI}${product.product_images[activePreview]}`}
            ...
            <div className="max-w-[445px] w-full">
              ...
              <div className="flex flex-wrap items-center gap-5 mb-6">
                <div className="flex items-center gap-1.5">
                  ...
                  <span>
                    <span className="font-medium text-dark"> {product.average_rating} Rating </span>
                    <span className="text-dark-2"> ({product.total_ratings} reviews) </span>
                  </span>
                </div>
